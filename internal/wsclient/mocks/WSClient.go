...
// GetWeatherCondition mocks base method.
func (m *MockWSClient) GetWeatherCondition(arg0 wsclient.tempType, arg1 float64) (wsclient.weatherCondition, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWeatherCondition", arg0, arg1)
	ret0, _ := ret[0].(wsclient.weatherCondition)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetWeatherCondition indicates an expected call of GetWeatherCondition.
func (mr *MockWSClientMockRecorder) GetWeatherCondition(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWeatherCondition", reflect.TypeOf((*MockWSClient)(nil).GetWeatherCondition), arg0, arg1)
}
